...
```Added``` entities should be handled in a different step to ensure that the auto-increment PK values have already been generated by EF Core before.
...
Then register it into the ```DbContext```:
