...
It's a modern and generic data access structure for .NET and Microsoft.EntityFrameworkCore. It supports UnitOfWork, Repository and QueryBuilder patterns. It also includes auto history utilities, multiple databases support with distributed transactions and databases/tables sharding for some database providers.
 ...
 | Package | NuGet |
 | ------- | ----- |
 | EntityFrameworkCore.Data.AutoHistory | [![Nuget](https://img.shields.io/badge/nuget-v3.0.5-blue) ![Nuget](https://img.shields.io/nuget/dt/EntityFrameworkCore.Data.AutoHistory)](https://www.nuget.org/packages/EntityFrameworkCore.Data.AutoHistory/3.0.5) |
 | EntityFrameworkCore.Data.QueryBuilder | [![Nuget](https://img.shields.io/badge/nuget-v3.0.5-blue) ![Nuget](https://img.shields.io/nuget/dt/EntityFrameworkCore.Data.QueryBuilder)](https://www.nuget.org/packages/EntityFrameworkCore.Data.QueryBuilder/3.0.5) |
 | EntityFrameworkCore.Data.Repository | [![Nuget](https://img.shields.io/badge/nuget-v3.0.5-blue) ![Nuget](https://img.shields.io/nuget/dt/EntityFrameworkCore.Data.Repository)](https://www.nuget.org/packages/EntityFrameworkCore.Data.Repository/3.0.5) |
 | EntityFrameworkCore.Data.UnitOfWork | [![Nuget](https://img.shields.io/badge/nuget-v3.0.5-blue) ![Nuget](https://img.shields.io/nuget/dt/EntityFrameworkCore.Data.UnitOfWork)](https://www.nuget.org/packages/EntityFrameworkCore.Data.UnitOfWork/3.0.5) |
...
```
Install-Package EntityFrameworkCore.Data.AutoHistory -Version 3.0.5
Install-Package EntityFrameworkCore.Data.QueryBuilder -Version 3.0.5
Install-Package EntityFrameworkCore.Data.Repository -Version 3.0.5
Install-Package EntityFrameworkCore.Data.UnitOfWork -Version 3.0.5
```
